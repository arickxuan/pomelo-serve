...
func NewUserServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UserServiceClient {
	...
	return &userServiceClient{
		register: connect.NewClient[pb.RegisterRequest, pb.RegisterResponse](
			httpClient,
...
type userServiceClient struct {
	register *connect.Client[pb.RegisterRequest, pb.RegisterResponse]
}
...
func (UnimplementedUserServiceHandler) Register(context.Context, *pb.RegisterRequest) (*pb.RegisterResponse, error) {
