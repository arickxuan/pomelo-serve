...
func (a *AccountService) Register(ctx context.Context, req *pb.RegisterRequest) (*pb.RegisterResponse, error) {
	//写注册的业务逻辑
...
func (a *AccountService) wxRegister(req *pb.RegisterRequest) (*entity.Account, *msError.Error) {
